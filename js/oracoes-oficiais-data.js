...
var ORACOES_OFICIAIS_DATA = [
  {
    ...
    "titulo": "Pai Nosso",
    "texto": "V. Pai nosso, que estais nos céus, santificado seja o Vosso nome; venha a nós o Vosso reino; seja feita a Vossa vontade, assim na terra como no céu.\nR. O pão nosso de cada dia nos dai hoje; perdoai-nos as nossas ofensas, assim como nós perdoamos a quem nos tem ofendido; e não nos deixeis cair em tentação, mas livrai-nos do mal. Amém.",
    "colapsarNaFala": true
  },
  {
    "id": "oficial_ave_maria",
    "titulo": "Ave Maria",
    "texto": "V. Ave Maria, cheia de graça, o Senhor é convosco; bendita sois Vós entre as mulheres, e bendito é o fruto do Vosso ventre, Jesus.\nR. Santa Maria, Mãe de Deus, rogai por nós, pecadores, agora e na hora da nossa morte. Amém.",
    "colapsarNaFala": true
  },
  {
    "id": "oficial_gloria",
    "titulo": "Glória ao Pai",
    "texto": "V. Glória ao Pai e ao Filho e ao Espírito Santo.\nR. Como era no princípio, agora e sempre. Amém.",
    "colapsarNaFala": true
  },
  {
    "id": "oficial_mqtuc5nv",
  ...
  },
  {
    ...
    "texto": "{bloco: São Miguel Arcanjo}\nV. São Miguel Arcanjo, defendei-nos no combate; sede nosso refúgio contra as maldades e as ciladas do demônio. Ordene-lhe Deus, instantemente o pedimos, e vós, príncipe da milícia celeste, pela virtude Divina precipitai no inferno a Satanás e a todos os espíritos malignos que andam pelo mundo para perder as almas. \nR. Amém.\n{/bloco}",
    "oculta": false,
    "colapsarNaFala": false
  },
  {
  ...
  },
  {
    ...
    "texto": "{bloco: Santíssimos corações de Jesus e Maria}\nV. Santíssimos corações de Jesus e Maria, unidos no amor perfeito,\ncomo nos olhais com carinho e misericórdia, consagramos nossos corações, nossas vidas, e nossas famílias a Vós.\nConhecemos que o belo exemplo de Vosso lar em Nazaré foi um modelo\npara cada uma de nossas famílias.\nEsperamos obter, com Vossa ajuda, a união e o amor forte e perdurável\nque vos destes.\nQue nosso lar seja cheio de alegria. Que o afeto sincero, a paciência, a tolerância, e o respeito mútuo sejam dados livremente a todos.\nQue nossas orações incluam as necessidades dos outros, não somente as nossas. E que sempre estejamos próximos dos sacramentos.\nAbençoai a todos os presentes e também aos ausentes, tantos os vivos como os defuntos; que a paz estejam conosco, e quando formos provados, concedei a resignação cristã à vontade de Deus.\nMantende nossas famílias perto de Vossos Corações; que Vossa proteção especial esteja sempre conosco.\nSagrados Corações de Jesus e Maria, escutai nossa oração.\nR. Amém.\n{/bloco}",
    "oculta": false,
    "colapsarNaFala": false
  },
  {
    "id": "oficial_mqv9rxby",
    "titulo": "Os sete Pai Nossos de Santa Brígida",
    "texto": "{bloco: Os sete Pai Nossos de Santa Brígida}\nV. Oremos. Ó Jesus, agora desejo recitar sete vezes o Pai-Nosso, em união com o mesmo amor pelo qual esta oração santificou e suavizou o Seu Coração. Aceite-a dos meus lábios em Seu divino Coração. Corrija-a e aperfeiçoe-a para que ela traga à Santíssima Trindade tanta honra e alegria quanto Você declarou para nós na Terra. Esta oração deve inundar a Sua Santa Humanidade para glorificar Suas Santas Chagas e o Precioso Sangue que delas derramou.\n\nV. Primeiro Pai Nosso: Circuncisão de Jesus\n[Pai Nosso]\n[Ave Maria]\nV. PAI de Nosso Senhor JESUS CRISTO, pelas mãos imaculadas de Maria, eu vos ofereço as primeiras chagas, as primeiras dores, e a primeira evasão do preciosíssimo Sangue derramado por JESUS, para expiar os pecados da humanidade, especialmente da juventude, os meus, e para a renúncia aos primeiros pecados, especialmente os mortais, sobretudo da minha família.\nR. Amém.\n\nV. Segundo Pai Nosso: O Suor de Sangue\n[Pai Nosso]\n[Ave Maria]\nV. PAI de Nosso Senhor JESUS CRISTO, pelas mãos imaculadas de Maria, eu vos ofereço as dores atrozes do Coração de JESUS no jardim das Oliveiras, e cada gota de Sangue, para expiar todos os pecados do coração de cada pessoa, os meus, para a renúncia  a tais pecados e para que aumente o amor a DEUS e ao próximo.\nR. Amém.\n\nV. Terceiro Pai Nosso: Flagelação de Jesus\n[Pai Nosso]\n[Ave Maria]\nV. PAI de Nosso Senhor JESUS CRISTO, pelas mãos imaculadas de Maria, eu vos ofereço todas as chagas, as dores cruéis, e o Preciosíssimo Sangue de JESUS na flagelação, por todos os pecados da carne, da humanidade, pelos meus, para a renúncia a tais pecados e para a aquisição e conservação da pureza, em especial da minha família.\nR. Amém.\n\nV. Quarto Pai Nosso: Coroação de Espinhos\n[Pai Nosso]\n[Ave Maria]\nV. PAI de Nosso Senhor JESUS CRISTO, pelas mãos imaculadas de Maria, eu vos ofereço as chagas, as dores, e o Preciosíssimo Sangue da Sagrada Cabeça de JESUS na coroação de espinhos, para expiar todos os pecados dos pensamentos, da humanidade, os meus, para a renúncia a todos os pecados, e para a extensão do Reino de CRISTO sobre a terra.\nR. Amém.\n\nV. Quinto Pai Nosso: Caminho da Cruz\n[Pai Nosso]\n[Ave Maria]\nV. PAI de Nosso Senhor JESUS CRISTO, pelas mãos imaculadas de Maria, eu vos ofereço as dores de JESUS no caminho do calvário, sobretudo na sua santa chaga do ombro, ofereço também o seu preciosíssimo Sangue, para aliviar o peso da Cruz, para reparar os meus murmúrios, para a renúncia a todos os pecados cometidos, e para que haja um verdadeiro amor á Santa Cruz.\nR. Amém.\n\nV. Sexto Pai Nosso: Crucificação de Jesus\n[Pai Nosso]\n[Ave Maria]\nV. PAI de Nosso Senhor JESUS CRISTO, pelas mãos imaculadas de Maria, eu vos ofereço o vosso Unigênito FILHO cravado na Cruz, as chagas das mãos e dos pés, e os fios de seu Preciosíssimo Sangue derramado por nós, seu extremo aniquilamento, a sua perfeita obediência, e todas as aflições mortais de seu Corpo e Alma. Ofereço-vos a sua preciosa Morte na Cruz que se renova constantemente em cada Santa Missa no Mundo inteiro, para expiar os atentados aos votos e às santas instituições, em reparação dos meus pecados e dos pecados do Mundo inteiro, pelos doentes  e moribundos, para obter santos sacerdotes e leigos, pelas intenções do Papa, pela restauração da família cristã, para fortificar e encorajar  a Fé, pela nossa Pátria, pela unidade de todos os povos em CRISTO e na vossa Igreja, assim como por todos os Países onde os cristãos estão em minoria.\nR. Amém.\n\nV. Sétimo Pai Nosso: Abertura do Santo Lado\n[Pai Nosso]\n[Ave Maria]\nV. PAI de Nosso Senhor JESUS CRISTO, pelas mãos imaculadas de Maria, aceitai os preciosíssimos dons da Água e do Sangue, que jorraram da chaga do Divino Coração de JESUS, pelas necessidades da Igreja e em expiação dos pecados da humanidade. Sangue propulsado pelo Sacratíssimo Coração de JESUS, lavai-me e purificai-me de todos os meus pecados. Água do Lado de CRISTO, lavai-me e purificai-me de meus primeiros pecados, e salvai-me como a todas as almas das chamas do Purgatório.\nR. Amém.\n\n{/bloco}",
    "oculta": false,
    "colapsarNaFala": false
  },
  {
    "id": "oficial_mqv9xcwa",
    "titulo": "Coroa das lágrimas (setena)",
    "texto": "[Coroa das lágrimas (contas grandes)|oficial_mr3x3u53]\n[Coroa das lágrimas (contas pequenas)|oficial_mqva6v5p]{7}\n\n",
    "oculta": true,
    "colapsarNaFala": false
  },
  {
  ...
  {
    "id": "oficial_mqy7tofl",
    "titulo": "Santo Rosário (ladainha)",
    "texto": "V. Ave Maria Filha de Deus Pai, cheia de graça, o Senhor é convosco; bendita sois Vós entre as mulheres, e bendito é o fruto do Vosso ventre, Jesus.\nR. Santa Maria, Mãe de Deus, rogai por nós, pecadores, agora e na hora da nossa morte. Amém.\nV. Ave Maria Mãe de Deus Filho, cheia de graça, o Senhor é convosco; bendita sois Vós entre as mulheres, e bendito é o fruto do Vosso ventre, Jesus.\nR. Santa Maria, Mãe de Deus, rogai por nós, pecadores, agora e na hora da nossa morte. Amém.\nV. Ave Maria Esposa de Deus Espírito Santo, cheia de graça, o Senhor é convosco; bendita sois Vós entre as mulheres, e bendito é o fruto do Vosso ventre, Jesus.\nR. Santa Maria, Mãe de Deus, rogai por nós, pecadores, agora e na hora da nossa morte. Amém.\n[pausa]{2}\nV. Senhor, tende piedade de nós.\nR. Senhor, tende piedade de nós.\nV. Jesus Cristo, tende piedade de nós.\nR. Jesus Cristo, tende piedade de nós.\nV. Senhor, tende piedade de nós.\nR. Senhor, tende piedade de nós.\nV. Jesus Cristo, ouvi-nos.\nR. Jesus Cristo, ouvi-nos.\nV. Jesus Cristo, atendei-nos.\nR. Jesus Cristo, atendei-nos.\n{R. Tende piedade de nós.}\nV. Deus Pai do céus.\nV. Deus Filho Redentor do mundo,\nV. Deus Espírito Santo,\nV. Santíssima Trindade, que sois um só Deus,\n[pausa]{2}\n{R. Rogai por nós}\nV. Santa Maria, \nV. Santa Mãe de Deus,\nV. Santa Virgem das virgens,\nV. Mãe de Jesus Cristo,\nV. Mãe da Igreja,\nV. Mãe da Misericórdia,\nV. Mãe da divina graça,\nV. Mãe da Esperança,\nV. Mãe puríssima,\nV. Mãe castíssima,\nV. Mãe intacta,\nV. Mãe amável,\nV. Mãe admirável,\nV. Mãe do bom conselho,\nV. Mãe do Criador,\nV. Mãe do Salvador,\nV. Virgem prudentíssima,\nV. Virgem veneranda,\nV. Virgem digna de louvor,\nV. Virgem poderosa,\nV. Virgem clemente,\nV. Virgem fiel,\nV. Espelho da justiça,\nV. Sede da Sabedoria,\nV. Causa da nossa alegria,\nV. Vaso espiritual,\nV. Vaso honorável,\nV. Vaso insigne de devoção,\nV. Rosa mística,\nV. Torre de Davi,\nV. Torre de marfim,\nV. Casa de ouro,\nV. Arca da aliança,\nV. Porta do céu,\nV. Estrela da manhã,\nV. Saúde dos enfermos,\nV. Refúgio dos pecadores,\nV. Conforto dos Migrantes\nV. Consoladora dos aflitos,\nV. Auxílio dos cristãos,\nV. Rainha dos Anjos,\nV. Rainha dos Patriarcas,\nV. Rainha dos Profetas,\nV. Rainha dos Apóstolos,\nV. Rainha dos Mártires,\nV. Rainha dos Confessores,\nV. Rainha das Virgens,\nV. Rainha de todos os Santos,\nV. Rainha concebida sem pecado original,\nV. Rainha assunta aos céus,\nV. Rainha do Santíssimo Rosário,\nV. Rainha da Família,\nV. Rainha da Paz,\n{}\n[pausa]{2}\n[Cordeiro de Deus]\n[pausa]{2}\nÀ Vossa proteção nós acolhemos, Santa Mãe de Deus, não desprezeis as súplicas que em nossas necessidades Vos dirigimos, mas livrai-nos sempre de todos os perigos, ó Virgem gloriosa e bendita.\nV. Rogai por nós, Santa Mãe de Deus.\nR. Para que sejamos dignos das promessas de Cristo.\nV. Oremos. Infundi, Senhor, nós Vos pedimos, em nossas almas a Vossa graça, para que nós, que conhecemos pela anunciação do Anjo a Encarnação de Jesus Cristo, Vosso Filho, cheguemos por sua Paixão e sua Cruz à glória da Ressurreição. Pelo mesmo Jesus Cristo, Senhor nosso.\nR. Amém.\n[pausa]{2}\nPelas necessidades da Igreja e do Estado.\n[Pai Nosso]\n[Ave Maria]\n[Glória ao Pai]\nPela pessoa e intenções do Senhor Bispo desta diocese e para que Nossa Senhora cubra com o seu manto toda a nossa família.\n[Pai Nosso]\n[Ave Maria]\n[Glória ao Pai]\nPelas benditas almas do purgatório.\n[Pai Nosso]\n[Ave Maria]\nV. Descanse em paz\nR. Amém.\nV. Santa Maria esperança nossa sede da sabedoria\nR. Rogai por nós.\nÓ Maria concebida sem pecado, rogai por nós e pelo nosso pobre mundo.\nQuanto mais culpado é, tanto mais tem necessidade de Vossa interseção.\nUma palavra vossa a Jesus e nosso mundo será salvo.\nÓ Jesus que nada negais a vossa Mãe Santíssima salvai nosso pobre mundo.\nR. Amém.\n[pausa]{2}\n[Oração pelas Santas Almas do Purgatório]\n[pausa]{2}\n[Augusta Rainha dos Céus]\n",
    "oculta": false,
    "colapsarNaFala": false
  },
  {
    ...
    "texto": "Pelo sinal da Santa Cruz, livrai-nos, Deus, Nosso Senhor, dos nossos inimigos. Em nome do Pai e do Filho e do Espírito Santo. \nR. Amém.",
    "oculta": false,
    "colapsarNaFala": false
  },
  {
  ...
  {
    "id": "oficial_mr0sp1pa",
    "titulo": "Terço da Sagrada Face (pai)",
    "texto": "V. Por tudo quanto sofrestes por nossa salvação, \nR. ponde fim à nossa mágoa! Alívio à nossa aflição!\n",
    "oculta": true,
    "colapsarNaFala": false
  },
  {
    "id": "oficial_mr0sugzb",
    "titulo": "Terço da Sagrada Face",
    "texto": "{bloco: Terço da Sagrada Face}\n[Sinal da cruz]\n\nOferecimento:\nÓ Sagrada Face adorável do Divino Redentor, Espelho de sofrimento, emblema santo de dor, Pelos tormentos atrozes sofridos em Vossa Cruz, Aceitai nossas torturas, para consolar-Vos, Jesus.\n\n[Credo (Símbolo dos Apóstolos)]\n\n[Terço da Sagrada Face (pai)|oficial_mr0sp1pa]\n[Terço da Sagrada Face (ave)|oficial_mr0zd26q]{3}\n[Terço da Sagrada Face (gloria)|oficial_mr9cwpru]\n\nNo primeiro mistério contemplamos a agonia de Nosso Senhor Jesus Cristo no monte das oliveiras onde suou sangue percorrendo por toda a terra na extrema angustia.\n[Terço da Sagrada Face (dezena)|oficial_mr9cy94s]\n\nNo segundo mistério contemplamos a dura flagelação de Nosso Senhor Jesus Cristo atado à coluna.\n[Terço da Sagrada Face (dezena)|oficial_mr9cy94s]\n\nNo terceiro mistério contemplamos a coroação de espinho de Nosso Senhor Jesus Cristo.\n[Terço da Sagrada Face (dezena)|oficial_mr9cy94s]\n\nNo quarto mistério contemplamos Nosso Senhor Jesus Cristo carregado a pesada Cruz rumo ao calvário, pedimos pelos méritos das Santas Chagas do ombro de Nosso Senhor Jesus Cristo.\n[Terço da Sagrada Face (dezena)|oficial_mr9cy94s]\n\nNo quinto mistério contemplamos a crucificação e morte de Nosso Senhor Jesus Cristo.\n[Terço da Sagrada Face (dezena)|oficial_mr9cy94s]\n[pausa]{2}\n\nConsagração:\nÓ meu bom Jesus, que quiseres salvar o mundo de hoje com aquele infinito amor com que foi criado e redimido, incluí-me também entre aqueles que querem trabalhar pelo triunfo de Vosso reino de amor na terra.\nRecebei, para este fim, a total entrega de todo o meu ser. Disponde de mim. Quero difundir a imagem de Vossa Divina Face, para que em todas as almas Vossa imagem se renove. Jesus, operai milagres de conversão. Chamai apóstolos para esta nova era, que por sua vez se encarreguem dessa nova missão. Que as ondas de Vosso misericordioso amor se espalhem sobre o mundo inteiro e, afundando e destruindo os males, renovem a terra e façam com que os homens, ao sentir seus corações tomados de caridade, voltem a viver o Santo Evangelho à luz deste sol que é a Vossa Face.\n[pausa]{2}\n[Terço Sagrada Face (ladainha)]\n[pausa]{2}\n[link:https://youtube.com/watch?v=j29fqAQqaTk&si=1HeDm-PjZ-5KV0dW]\n\n{/bloco}\n",
    "oculta": false,
    "colapsarNaFala": false
  },
  {
    "id": "oficial_mr0t0lrf",
    "titulo": "Terço Sagrada Face (ladainha)",
    "texto": "{R. tende piedade de nós.}\nV. Senhor, \nV. Cristo,\nV. Senhor,\nV. Jesus Cristo, \nR. ouvi-nos.\nV. Jesus Cristo, \nR. atendei-nos.\n[pausa]{2}\nV. Deus Pai do Céu, \n{R. tende piedade de nós.}\nV. Deus Filho, Redentor do Mundo, \nV. Deus Espírito Santo, \nV. Santíssima Trindade, que sois um só Deus, \n[pausa]{2}\nV. Sagrada Face do Filho de Deus vivo, \nV. Sagrada Face, espelho da majestade divina, \nV. Sagrada Face do nosso Salvador, \nV. Sagrada Face, inundada de suor e sangue, \nV. Sagrada Face, humilhada pelo beijo do traidor, \nV. Sagrada Face, barbaramente contundida por bofetões, \nV. Sagrada Face, acumulada de ignomínias e insultos, \nV. Sagrada Face, coberta dum véu e cinicamente ludibriada, \nV. Sagrada Face, atormentada por febre e sede, \nV. Sagrada Face, no julgamento, perante a multidão amotinada, \nV. Sagrada Face, banhada de lágrimas de dor, \nV. Sagrada Face, impressa na toalha de Verônica, \nV. Sagrada Face, coberta de blasfêmias horrendas, \nV. Sagrada Face, ao morrer na Cruz, inclinada para nós, \nV. Sagrada Face, desfigurada por feridas e golpes, \nV. Sagrada Face, revelada milagrosamente no Santo Sudário, \nV. Sagrada Face, glorificada pela ressurreição, tende piedade de nós.\nV. Sagrada Face, alegria de todos os anjos e santos, \nV. Sagrada Face, por cuja veneração alcançamos auxílio nas angústias, \n{}\n[pausa]{2}\nV. Cordeiro de Deus, que tirais o pecado do mundo, \nR. mostrai-nos a Vossa Sagrada Face, \nV. volvei a nós Vossa Sagrada Face, \nR. a fim de sermos salvos. Amém.",
    "oculta": true,
    "colapsarNaFala": false
  },
  {
    "id": "oficial_mr0zd26q",
    "titulo": "Terço da Sagrada Face (ave)",
    "texto": "V. Sagrada Face do Senhor, \nR. Aliviai a nossa dor!",
    "oculta": true,
    "colapsarNaFala": false
  },
  {
    ...
    "texto": "V. Ó meu Jesus, perdoai-nos, livrai-nos do fogo do inferno; levai as almas todas para o Céu, e socorrei principalmente as que mais precisarem.\nR. Ó Virgem Dolorosíssima, as Vossas Lágrimas derrubaram o império infernal!",
    "oculta": true,
    "colapsarNaFala": false
  },
  {
  ...
  {
    "id": "oficial_mr9c3zpa",
    "titulo": "fazer seu pedido",
    "texto": "com confiança fazer seu pedido",
    "oculta": true,
    "colapsarNaFala": true
  },
  {
    "id": "oficial_mr9cwpru",
    "titulo": "Terço da Sagrada Face (gloria)",
    "texto": "V. Face de Jesus, \nR. suavizai a nossa Cruz!",
    "oculta": true,
    "colapsarNaFala": false
  },
  {
    "id": "oficial_mr9cy94s",
    "titulo": "Terço da Sagrada Face (dezena)",
    "texto": "[Terço da Sagrada Face (pai)|oficial_mr0sp1pa]\n[Terço da Sagrada Face (ave)|oficial_mr0zd26q]{10}\n[Terço da Sagrada Face (gloria)|oficial_mr9cwpru]\n",
    "oculta": true,
    "colapsarNaFala": false
  },
  {
    "id": "oficial_mr9jahah",
    "titulo": "Terço de São Miguel Arcanjo (ou Coroa Angélica)",
    "texto": "{bloco: Terço de São Miguel Arcanjo}\n[link:https://www.youtube.com/watch?v=diM2Obyrm-0]\n[pausa]{2}\n[Sinal da cruz|oficial_mr0skuf2]\nV. Deus, vinde em nosso auxílio\nR. Senhor, socorrei-nos e salvai-nos.\n[pausa]{2}\nPrimeira saudação\nPela intercessão de São Miguel e do coro celeste dos Serafins, fazei-nos Senhor dignos de sermos inflamados por uma perfeita caridade.\nR. Amém.\n[Pai Nosso|oficial_pai_nosso]\n[Ave Maria|oficial_ave_maria]{3}\n[pausa]{2}\nSegunda saudação\nPela intercessão de São Miguel e do coro celeste dos Querubins, concedei-nos Senhor, a graça de abandonarmos a estrada do pecado e trilharmos a estrada da perfeição cristã.\nR. Amém.\n[Pai Nosso|oficial_pai_nosso]\n[Ave Maria|oficial_ave_maria]{3}\n[pausa]{2}\nTerceira saudação\nPela intercessão de São Miguel e do coro celeste dos Tronos, derramai Senhor em nossos corações o espírito de uma verdadeira e sincera humildade.\nR. Amém.\n[Pai Nosso|oficial_pai_nosso]\n[Ave Maria|oficial_ave_maria]{3}\n[pausa]{2}\nQuarta saudação\nPela intercessão de São Miguel e do coro celeste das Dominações, dai-nos Senhor a graça de podermos dominar os nossos sentidos e corrigir as nossas más paixões.\nR. Amém.\n[Pai Nosso|oficial_pai_nosso]\n[Ave Maria|oficial_ave_maria]{3}\n[pausa]{2}\nQuinta saudação\nPela intercessão de São Miguel e do coro celeste das Potestades, guardai-nos Senhor as nossas almas, das emboscadas e tentações do demônio.\nR. Amém.\n[Pai Nosso|oficial_pai_nosso]\n[Ave Maria|oficial_ave_maria]{3}\n[pausa]{2}\nSexta saudação\nPela intercessão de São Miguel e do coro celeste das Virtudes Celestes, concedei-nos Senhor a graça de não sermos vencidos no combate perigoso das tentações mas livrai-nos do mal.\nR. Amém.\n[Pai Nosso|oficial_pai_nosso]\n[Ave Maria|oficial_ave_maria]{3}\n[pausa]{2}\nSétima saudação\nPela intercessão de São Miguel e do coro celeste dos Principados, enchei Senhor, nossas almas, com o espírito de uma verdadeira e sincera obediência.\nR. Amém.\n[Pai Nosso|oficial_pai_nosso]\n[Ave Maria|oficial_ave_maria]{3}\n[pausa]{2}\nOitava saudação\nPela intercessão de São Miguel e do coro celeste dos Arcanjos, concedei-nos Senhor que estes espíritos bem aventurados nos guardem durante essa vida mortal, para nos conduzirem depois à glória eterna do céu.\nR. Amém.\n[Pai Nosso|oficial_pai_nosso]\n[Ave Maria|oficial_ave_maria]{3}\n[pausa]{2}\nNona saudação\nPela intercessão de São Miguel e do coro celeste dos Anjos, concedei-nos Senhor o dom da perseverança na fé e nas boas obras para podermos chegar à glória do Paraiso.\nR. Amém.\n[Pai Nosso|oficial_pai_nosso]\n[Ave Maria|oficial_ave_maria]{3}\nUm Pai Nosso em honra a São Miguel\n[Pai Nosso|oficial_pai_nosso]\nUm Pai Nosso em honra a São Gabriel\n[Pai Nosso|oficial_pai_nosso]\nUm Pai Nosso em honra a São Rafael\n[Pai Nosso|oficial_pai_nosso]\nUm Pai Nosso em honra ao nosso Anjo da Guarda\n[Pai Nosso|oficial_pai_nosso]\nRezemos a antífona:\nÓ Gloriosíssimo São Miguel, chefe e príncipe das milícias celestes, guarda fiel das almas, vencedor dos demônios, favorito da casa de Deus, Vós que acima de todos os anjos sois admirável protetor nosso, dotado de sobre-humana e excelência virtude, dignai-vos livrar-nos de todos os males, já que a vós recorremos com toda confiança e alcançai-nos com a vossa incomparável proteção, que avancemos cada dia na fidelidade em servir a Deus.\nRogai por nós, ó bem aventurado São Miguel, príncipe da Igreja de Jesus Cristo, para que sejamos dignos de suas promessas.\nV. Oremos.\nDeus todo poderoso e eterno. Que por um prodígio de bondade e misericórdia, para a salvação comum dos homens, escolhestes para defensor da Vossa Igreja, o glorioso Arcanjo São Miguel, fazei nós vos suplicamos que sejamos dignos de ser libertados pela sua benéfica proteção de todos os nossos inimigos e que nenhum deles nos possa inquietar na hora da nossa morte e que nos seja concedido ser por ele conduzidos à presença da Vossa Excelsa e Divina Majestade.\nPelos méritos de Jesus Cristo Nosso Senhor.\nR. Amém.\nEm nome do Pai, do Filho e do Espírito Santo.\nR. Amém.\n\n{/bloco}",
    "oculta": false,
    "colapsarNaFala": false
  },
  {
    "id": "oficial_mr9onqxi",
    "titulo": "Consagração ao Imaculado Coração de Maria",
    "texto": "{bloco: Consagração ao Imaculado Coração de Maria}\nÓ coração imaculado da virgem puríssima maria, nossa mãe, eu, pobre pecador, encerro o meu coração fraco, manchado pelos pecados, em vós! Acolhei-me para sempre, segurai-me firmemente e nunca mais me largueis do vosso poder amoroso, para que eu seja protegido de mim mesmo e aconchegado na vossa misericórdia.\nConsagro-vos toda a minha vida e a minha morte, todos os meus pensamentos, palavras e atos.\nQuero amar como vós amais. quero oferecer como vós ofereceis. quero silenciar como vós silenciais. \nQuero perdoar como vós perdoais. E quero ser assim como vós quereis que eu seja, a fim de que possais guiar-me até ao meu senhor e meu deus, ao seu coração amoroso, que é a meta e a felicidade de todos nós. \nE também a vós, santos e grandes anjos, peço que vos lembreis desta minha consagração a maria, que me admoesteis, me advirtais, me guieis e nunca mais me deixeis cair. \nSanto e fiel anjo da guarda todos vós, auxiliadores e irmãos celestes, acolhei-me como um grão de semente que é confiado à vossa custódia. \nE que, cuidado por vós, há de dar fruto para a eternidade. \nR. Amém.\n{/bloco}\n",
    "oculta": false,
    "colapsarNaFala": false
  },
  {
    "id": "oficial_mr9ot8x6",
    "titulo": "Couraça de São Patrício",
    "texto": "{bloco: Couraça de São Patrício}\nHoje me levanto com poderosa força e invoco à Santíssima Trindade com Trinitária fé professando a unidade do Criador e da criatura.\nHoje me levanto com a força do nascimento de Cristo, com a graça do seu batismo, com a força de sua crucificação e morte, com a força de sua ressurreição e ascensão, com a força de seu retorno no dia do juízo.\nHoje me levanto com a força do amor do Querubim, obediente aos anjos, a serviço dos arcanjos, na esperança da ressurreição para encontrar consolo com as orações dos patriarcas, as predições dos profetas, os ensinamentos dos apóstolos, a fé dos confessores, a inocência das santas virgens, os feitos dos homens de bem.\nHoje me levanto com a força dos céus: a luz do sol, o brilho da lua, o esplendor do fogo, a velocidade do trovão, a rapidez do vento, a profundidade dos mares, a permanência da terra, a firmeza da rocha.\nHoje me levanto com a força de Deus que me guia: sua grandeza que me apoia, sua sabedoria que me guia, seu olho que me cuida, seu ouvido que me escuta, sua palavra que me fala, sua mão que me defende, seu caminho para segui-lo, seu escudo para proteger-me, sua Eucaristia para livrar-me das armadilhas do demônio, da tentação dos vícios, daqueles que me desejam o mal, longe ou perto, só ou acompanhado.\nInvoco hoje estes poderes para que se levantem entre mim e estes males, contra todos e cruéis infames poderes que desejam o mal, para meu corpo, contra as invocações dos falsos profetas, contra as nefastas leis da pagania, contra as falsas leis da heresia, contra as artes da idolatria, contra os feitiços das bruxas, quiromantes e feiticeiros, contra todo conhecimento que corrompe o corpo e a alma.\nCristo que me protege hoje contra o veneno, contra o fogo, contra morrer afogado, contra ser ferido, para que assim venha a mim abundante consolo.\n\nCristo comigo,\nCristo à minha frente,\nCristo atrás de mim,\nCristo em mim,\nCristo abaixo de mim,\nCristo sobre mim,\nCristo à minha direita,\nCristo à minha esquerda,\nCristo quando me deito,\nCristo quando me sento,\nCristo quando me levanto,\nCristo no coração de todo homem que pensa em mim,\nCristo na boca de quem fale de mim,\nCristo em todo olho que me vê,\nCristo em todo ouvido que me ouve.\n\nHoje me levanto com poderosa força e invoco à Santíssima Trindade com trinitária fé professando a unidade do Criador e da criatura. \nR. Amém.\n{/bloco}",
    "oculta": false,
    "colapsarNaFala": false
  },
  {
    ...
    "texto": "{bloco: Adoção Espiritual}\nV. Oremos.\nSenhor Jesus, pela intercessão de Maria, Vossa Mãe, que Vos acolheu com amor, e pela intercessão de São José, homem de confiança que cuidou de Vós após o nascimento, peço-Vos por esta criança concebida, adotada espiritualmente por mim, que corre o perigo de ser abortada. Dai a sua mãe e aos outros familiares o amor e a coragem de deixá-la viver, Vós, que lhe concedestes a vida. \nR. Amém.\n{/bloco}\n\n[Adoção Espiritual (nota)|oficial_mrc0gddd]{opcional}\n\n",
    "oculta": false,
    "colapsarNaFala": false
  },
  {
    "id": "oficial_mrc0gddd",
    "titulo": "Adoção Espiritual (nota)",
    "texto": "A Adoção Espiritual é um amoroso acolhimento espiritual através da oração. Dura nove meses e consiste em uma recitação diária de um dos mistérios do Rosário e uma oração especial pela criança e por sua família.\n\nA adoção espiritual dos nascituros surgiu como fruto das aparições de Nossa Senhora em Fátima. Maria pediu que rezemos o Terço, façamos a penitência e reparação pelos pecados.\n\n[link:https://adocaoespiritual.org.br/pt]\n",
    "oculta": true,
    "colapsarNaFala": false
  },
  {
  ...
  },
  {
    ...
    "texto": "Senhor Jesus, Filho de Deus, tende piedade de mim por que sou um pecador.",
    "oculta": false,
    "colapsarNaFala": false
  },
  {
  ...
  },
  {
    ...
    "texto": "Mistérios Dolorosos\n{bloco: A oração no horto}\nPrimeiro Mistério: \n<b>A oração no horto</b>\n[São Josemaria (mistério doloroso1)|oficial_mrjcrqcb]{depende:São Josemaria  (santo rosario)|oficial_mrjd6kg1}\n[Santo Rosário (dezena)|oficial_mria0ch6]\n{/bloco}\n{bloco: A flagelação do Senhor}\nSegundo Mistério: \n<b>A flagelação do Senhor</b>\n[São Josemaria (mistério doloroso2)|oficial_mrjcsb9t]{depende:São Josemaria  (santo rosario)|oficial_mrjd6kg1}\n[Santo Rosário (dezena)|oficial_mria0ch6]\n{/bloco}\n{bloco: A coroação de espinhos}\nTerceiro Mistério: \n<b>A coroação de espinhos</b>\n[São Josemaria (mistério doloroso3)|oficial_mrjcsugn]{depende:São Josemaria  (santo rosario)|oficial_mrjd6kg1}\n[Santo Rosário (dezena)|oficial_mria0ch6]\n{/bloco}\n{bloco: A cruz as costas}\nQuarto Mistério: \n<b>A cruz as costas</b>\n[São Josemaria (mistério doloroso4)|oficial_mrjctigv]{depende:São Josemaria  (santo rosario)|oficial_mrjd6kg1}\n[Santo Rosário (dezena)|oficial_mria0ch6]\n{/bloco}\n{bloco: Jesus morre na cruz}\nQuinto Mistério: \n<b>Jesus morre na cruz</b>\n[São Josemaria (mistério doloroso5)|oficial_mrjctxxt]{depende:São Josemaria  (santo rosario)|oficial_mrjd6kg1}\n[Santo Rosário (dezena)|oficial_mria0ch6]\n{/bloco}",
    "oculta": false,
    "colapsarNaFala": false
  },
  {
    ...
    "texto": "Mistérios Luminosos\n{bloco: O batismo do Senhor}\nPrimeiro Mistério: \nO batismo do Senhor\n[São Josemaria (mistério luminoso1)|oficial_mrjd0jxv]{depende:São Josemaria  (santo rosario)|oficial_mrjd6kg1}\n[Santo Rosário (dezena)|oficial_mria0ch6]\n{/bloco}\n{bloco: As bodas de Caná}\nSegundo Mistério: \nAs bodas de Caná\n[São Josemaria (mistério luminoso2)|oficial_mrjd14qf]{depende:São Josemaria  (santo rosario)|oficial_mrjd6kg1}\n[Santo Rosário (dezena)|oficial_mria0ch6]\n{/bloco}\n{bloco: Anúncio da boa nova}\nTerceiro Mistério: \nAnúncio da boa nova\n[São Josemaria (mistério luminoso3)|oficial_mrjd1o9t]{depende:São Josemaria  (santo rosario)|oficial_mrjd6kg1}\n[Santo Rosário (dezena)|oficial_mria0ch6]\n{/bloco}\n{bloco: A transfiguração do Senhor}\nQuarto Mistério: \nA transfiguração do Senhor\n[São Josemaria (mistério luminoso4)|oficial_mrjd28cn]{depende:São Josemaria  (santo rosario)|oficial_mrjd6kg1}\n[Santo Rosário (dezena)|oficial_mria0ch6]\n{/bloco}\n{bloco: A instituição da Santa Eucaristia}\nQuinto Mistério: \nA instituição da Santa Eucaristia\n[São Josemaria (mistério luminoso5)|oficial_mrjd2r3h]{depende:São Josemaria  (santo rosario)|oficial_mrjd6kg1}\n[Santo Rosário (dezena)|oficial_mria0ch6]\n{/bloco}",
    "oculta": false,
    "colapsarNaFala": false
  },
  {
    ...
    "texto": "Mistérios Gloriosos\n{bloco: A ressurreição do Senhor}\nPrimeiro Mistério: \nA ressurreição do Senhor\n[São Josemaria (mistério glorioso1)|oficial_mrjcvfsp]{depende:São Josemaria  (santo rosario)|oficial_mrjd6kg1}\n[Santo Rosário (dezena)|oficial_mria0ch6]\n{/bloco}\n{bloco: A ascensão do Senhor aos céus}\nSegundo Mistério: \nA ascensão do Senhor aos céus\n[São Josemaria (mistério glorioso2)|oficial_mrjcw1nd]{depende:São Josemaria  (santo rosario)|oficial_mrjd6kg1}\n[Santo Rosário (dezena)|oficial_mria0ch6]\n{/bloco}\n{bloco: A vinda do Espírito Santo}\nTerceiro Mistério: \nA vinda do Espírito Santo\n[São Josemaria (mistério glorioso3)|oficial_mrjcwgg3]{depende:São Josemaria  (santo rosario)|oficial_mrjd6kg1}\n[Santo Rosário (dezena)|oficial_mria0ch6]\n{/bloco}\n{bloco: A assunção de Nossa Senhora}\nQuarto Mistério: \nA assunção de Nossa Senhora\n[São Josemaria (mistério glorioso4)|oficial_mrjcx48h]{depende:São Josemaria  (santo rosario)|oficial_mrjd6kg1}\n[Santo Rosário (dezena)|oficial_mria0ch6]\n{/bloco}\n{bloco: A coroação de Maria Santíssima}\nQuinto Mistério: \nA coroação de Maria Santíssima\n[São Josemaria (mistério glorioso5)|oficial_mrjcxkrv]{depende:São Josemaria  (santo rosario)|oficial_mrjd6kg1}\n[Santo Rosário (dezena)|oficial_mria0ch6]\n{/bloco}",
    "oculta": false,
    "colapsarNaFala": false
  },
  {
    "id": "oficial_mrcnmz8e",
    "titulo": "Santas Almas do Purgatório (nota)",
    "texto": "Nosso Senhor prometeu à Santa Gertrudes que salvaria MIL almas do purgatório todos os dias, por cada pessoa que rezar com fervor esta Oração:\nPara tanto , esta oração deve ser feita em um profundo estado de contrição para que possa ser realizada a promessa de Nosso Senhor Jesus Cristo.\n",
    "oculta": true,
    "colapsarNaFala": false
  },
  {
    "id": "oficial_mrcnu9ww",
    "titulo": "Augusta Rainha dos Céus (nota)",
  ...
  {
    "id": "oficial_msgmusmr",
    "titulo": "Coroa das Lágrimas (link)",
    "texto": "[link:https://youtu.be/3r0-Jb3TQbg?si=ngxhS42U-ASlkZcD]\n",
    "oculta": true,
    "colapsarNaFala": false
  },
  {
    "id": "oficial_msgn7ldn",
    "titulo": "Terço de São José (ave)",
  ...
  {
    "id": "oficial_msgn972n",
    "titulo": "Terço de São José (dezena)",
    "texto": "Meu glorioso São José, nas vossas maiores aflições e tribulações, não vos valeu o anjo do Senhor? Valei-me, São José!\n[Terço de São José (ave)|oficial_msgn7ldn]{10}\n",
    "oculta": true,
    "colapsarNaFala": false
  },
  {
    "id": "oficial_msgnateq",
    "titulo": "Terço de São José",
    "texto": "{bloco: Terço de São José}\n[Terço de São José (dezena)|oficial_msgn972n]{5}\n[pausa]{2}\nA vós, glorioso São José, ofereço este terço em louvor e glória de Jesus e Maria, para que seja minha luz e guia, minha proteção e defesa, minha fortaleza e alegria em todos os meus trabalhos e tribulações, principalmente na hora da agonia.\n\nPelo nome de Jesus, pela glória de Maria, imploro o vosso poderoso patrocínio, para que me alcanceis a graça que tanto desejo. Falai em meu favor, advogai a minha causa no Céu e na Terra, alegrai a minha alma para honra de Jesus, de Maria e vossa. \nR. Amém.\n{/bloco}",
    "oculta": false,
    "colapsarNaFala": false
  },
  {
  ...
  },
  {
    ...
    "texto": "{bloco: Oração a São José para obter a conversão de um pecador}\nÓ justo e glorioso São José, eu vos recomendo insistentemente a salvação da alma de ...\n[fazer seu pedido|oficial_mr9c3zpa]{opcional}\n[pausa]{2}\n, que Jesus resgatou à custa do seu sangue. Vós sabeis, grande santo, quanto são infelizes aqueles que, tendo banido do seu coração ao Divino Salvador, ficam expostos a perdê-lo por toda a eternidade.\n\nNão permitais, pois, que esta alma que me é tão querida, fique por muito tempo separada de Jesus. Mostrai-lhe os perigos que a ameaçam. Falai fortemente ao seu coração. Reconduzi este filho pródigo ao seio do melhor dos pais e não o deixeis, sem lhe terdes aberto as portas do Céu, onde vos bendirá eternamente pela felicidade que lhe tiverdes alcançado.\nR. Amém.\n{/bloco}",
    "oculta": false,
    "colapsarNaFala": false
  },
  {
  ...
  },
  {
    "id": "oficial_msq8uy8a",
    "titulo": "Salve Rainha",
    "texto": "{bloco: Salve Rainha}\nSalve, Rainha, mãe de misericórdia, vida, doçura, esperança nossa, salve! \nA Vós bradamos, os degredados filhos de Eva. \nA Vós suspiramos, gemendo e chorando neste vale de lágrimas. \nEia, pois, advogada nossa, esses Vossos olhos misericordiosos a nós volvei. \nE, depois deste desterro, nos mostrai Jesus, bendito fruto do Vosso ventre. \nÓ clemente, ó piedosa, ó doce Virgem Maria. Rogai por nós, Santa Mãe de Deus, para que sejamos dignos das promessas de Cristo.\n{/bloco}",
    "oculta": false,
    "colapsarNaFala": false
  },
  {
    "id": "oficial_msz8u7qj",
    "titulo": "Quaresma de São Miguel Arcanjo",
    "texto": "{bloco: Quaresma de São Miguel Arcanjo}\nOração inicial\n[São Miguel Arcanjo|oficial_mqv3i2ta]\nSacratíssimo Coração de Jesus.\nSacratíssimo Coração de Jesus.\nSacratíssimo Coração de Jesus.\n[pausa]{2}\nLadainha de São Miguel Arcanjo\nV. Senhor, \nR. tende piedade de nós.\nV. Jesus Cristo, \nR. tende piedade de nós.\nV. Senhor, \nR. tende piedade de nós.\nV. Jesus Cristo, \nR. ouvi-nos.\nV. Jesus Cristo, \nR. atendei-nos.\n{R. tende piedade de nós.}\nV. Pai Celeste, que sois Deus, \nV. Filho Redentor do Mundo, que sois Deus, \nV. Espírito Santo, que sois Deus, \nV. Trindade Santa, que sois um único Deus, \n{R. Rogai por nós}\nV. Santa Maria, Rainha dos Anjos, \nV. São Miguel,\nV. São Miguel, cheio da graça de Deus,\nV. São Miguel, perfeito adorador do Verbo Divino,\nV. São Miguel, coroado de honra e de glória,\nV. São Miguel, poderosíssimo príncipe dos exércitos do Senhor,\nV. São Miguel, porta-estandarte da Santíssima Trindade,\nV. São Miguel, guardião do Paraíso,\nV. São Miguel, guia e consolador do povo israelita,\nV. São Miguel, esplendor e fortaleza da Igreja militante,\nV. São Miguel, honra e alegria da Igreja triunfante,\nV. São Miguel, luz dos anjos,\nV. São Miguel, baluarte dos cristãos,\nV. São Miguel, força daqueles que combatem pelo estandarte da cruz,\nV. São Miguel, luz e confiança das almas no último momento da vida,\nV. São Miguel, socorro muito certo,\nV. São Miguel, nosso auxílio em todas as adversidades,\nV. São Miguel, arauto da sentença eterna,\nV. São Miguel, consolador das almas que estão no Purgatório,\nV. São Miguel, a quem o Senhor incumbiu de receber as almas que estão no Purgatório,\nV. São Miguel, nosso príncipe,\nV. São Miguel, nosso advogado,\n[pausa]{2}\n[Cordeiro de Deus|oficial_mr2m6vm1]\n[pausa]{2}\nRogai por nós, ó glorioso São Miguel, príncipe da Igreja de Cristo, para que sejamos dignos de Suas promessas.\nV. Oremos. Senhor Jesus, santificai-nos por uma bênção sempre nova e concedei-nos, pela intercessão de São Miguel, essa sabedoria que nos ensina a ajuntar riquezas do céu e a trocar os bens do tempo presente pelos da eternidade. Vós que viveis e reinais em todos os séculos dos séculos.\nR. Amém.\n[pausa]{2}\nConsagração\nÓ Príncipe nobilíssimo dos Anjos, valoroso guerreiro do Altíssimo, zeloso defensor da glória do Senhor, terror dos espíritos rebeldes, amor e delícia de todos os Anjos justos, meu diletíssimo Arcanjo São Miguel, desejando eu fazer parte do número dos vossos devotos e servos, a vós, hoje, me consagro, me dou e ofereço, e ponho-me a mim próprio, a minha família e tudo o que me pertence debaixo da vossa poderosíssima proteção.\nÉ pequena a oferta do meu serviço, sendo como sou um miserável pecador, mas vós engrandecereis o afeto do meu coração; recordai-vos que, de hoje em diante, estou debaixo do vosso sustento, e deveis assistir-me em toda a minha vida e obter-me o perdão dos meus muitos e graves pecados, a graça de amar a Deus de todo coração, ao meu querido Salvador Jesus Cristo e a minha Mãe Maria Santíssima.\nObtende-me aqueles auxílios que me são necessários para obter a coroa da eterna glória. Defendei-me dos inimigos da alma, especialmente na hora da morte. Vinde, ó príncipe gloriosíssimo, assistir-me na última luta, e, com a vossa arma poderosa, lançai para longe, precipitando nos abismos do inferno, aquele anjo quebrador de promessas e soberbo que um dia prostrastes no combate no Céu.\nSão Miguel Arcanjo, defendei-nos no combate para que não pereçamos no supremo juízo. \nR. Amém.\n{/bloco}",
    "oculta": false,
    "colapsarNaFala": false
  },
  {
    "id": "oficial_mt4upcet",
    "titulo": "Oração à Nossa Senhora desatadora dos nós",
    "texto": "Santa Maria, cheia da Presença de Deus, durante vossa vida aceitastes com toda a humildade a vontade do Pai e o Malígno nunca foi capaz de vos envolver em suas confusões; e junto a vosso filho intercedestes por nossas dificuldades e, com toda paciência, nos destes o exemplo de como desenrolar as linhas de nossa vida. Ao se dar para sempre como nossa Mãe, pondes uma ordem e fazeis mais estreitos os laços que nos unem ao senhor. Santa Maria, Mãe de Deus e nossa Mãe, Vós que com coração materno desatais os nós que entorpecem nossa vida, vos pedimos que recebais em vossas mãos o meu pedido (fazei o pedido)... e que nos livreis das amarras e confusões com que nos castiga aquele que é nosso inimigo. Por vossa graça, por vossa intercessão, com vosso exemplo, livrai-nos de todo o mal Senhora Nossa e desatais os nós que impedem de nos unirmos a Deus. Para que nos livre de toda confusão e erros, O louvemos em todas as coisas. NELE coloquemos nossos corações e possamos sempre Servi-lo através dos nossos irmãos. Prometo que serei devoto à vós e propagarei a muitos o vosso sagrado nome, para que outros necessitados recorram ao vosso auxílio maternal. \nR. Amém!",
    "oculta": false,
    "colapsarNaFala": false
  },
  {
    "id": "oficial_mt4uu99d",
    "titulo": "Oração ao Senhor por intercessão de São Pio de Pietrelcina",
    "texto": "{bloco: São Pio de Pietrelcina}\nÓ Deus, que doastes a São Pio de Pietrelcina, sacerdote capuchinho, o insigne privilégio de participar, de modo admirável, à Paixão do vosso Filho, por sua intercessão, dai-me a graça... que tanto desejo; e sobretudo, concedei-me unir à Paixão de Jesus, para depois chegar à sua gloriosa Ressurreição.\n[Glória ao Pai|oficial_gloria]{3}\n{/bloco}\n",
    "oculta": false,
    "colapsarNaFala": false
  },
  {
    "id": "oficial_mt4v2lyx",
    "titulo": "Coroinha ao Sagrado Coração de Jesus",
    "texto": "{bloco: Coroinha ao Sagrado Coração de Jesus}\nI. Ó meu Jesus, que dissestes: \"na verdade, vos digo, pedi e recebereis, procurai e achareis, batei e abrir-se-vos-á!\" eu bato, procuro e peço a graça…\n\n[Pai Nosso|oficial_pai_nosso]\n[Ave Maria|oficial_ave_maria]\n[Glória ao Pai|oficial_gloria]\nSagrado Coração de Jesus, eu confio e espero em vós.\n\nII. - Ó meu Jesus, que dissestes: \"na verdade, vos digo, tudo quanto pedirdes a meu Pai em meu nome, Ele vo-lo concederá!\", é ao vosso Pai e em vosso nome que peço a graça.…\n\n[Pai Nosso|oficial_pai_nosso]\n[Ave Maria|oficial_ave_maria]\n[Glória ao Pai|oficial_gloria]\nSagrado Coração de Jesus, eu confio e espero em vós.\n\nIII. - Ó meu Jesus, que dissestes: \"na verdade, vos digo, passará o céu e a terra, mas minhas palavras não passarão!\" confiado na infalibilidade de vossas palavras eu peço a graça..\n\n[Pai Nosso|oficial_pai_nosso]\n[Ave Maria|oficial_ave_maria]\n[Glória ao Pai|oficial_gloria]\nSagrado Coração de Jesus, eu confio e espero em vós.\n\nÓ Sagrado Coração de Jesus, a quem é impossivel não ter compaixão dos infelizes, tende piedade de nós, pobres pecadores, e concedei-nos as graças que vos pedimos por meio do Imaculado Coração de Maria, vossa e nossa terna Mãe.\n\nSão José, Pai adotativo do Sagrado Coração de Jesuss rogai por nós.\n\n[Salve Rainha|oficial_msq8uy8a]\n{/bloco}\n",
    "oculta": false,
    "colapsarNaFala": false
  }
];
